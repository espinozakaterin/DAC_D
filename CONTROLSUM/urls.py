...
from .views import ControlSumView as views 
...
urlpatterns = [
    ...
    path('get/areas/data', ControlSumView.get_areas_data, name='get_areas_data'),
    path('get/grupos/data', ControlSumView.get_grupos_data, name='get_grupos_data'),
    ...
    path( 'obtener/suministros/por/categoria/data', views.obtener_suministros_por_categoria_data, name='obtener_suministros_por_categoria_data'),
    path('obtener/todos/suministros/data',views.obtener_todos_suministros_data, name='obtener_todos_suministros_data'),
    ...
    path('obtener-precio-suministro/', ControlSumView.obtener_precio_suministro_data, name='obtener_precio_suministro_data'),
    ...
    path('buscar/sistema', ControlSumView.buscar_sistema, name='buscar_sistema'),
